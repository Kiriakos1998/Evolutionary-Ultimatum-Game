...
function [ps,qs]=model3GPU(grid,e,generations)
...
% the same place
triangleMatrix=tril(ones(5,5,'gpuArrays'))';
...
oneRow=ones(1,5,'gpuArrays');
oneRows=ones(1,4,'gpuArrays');
% initialize here matrix to save time
onesMatrix=ones(N,4,'gpuArrays');
...
cheatMatrix=gpuArray(opponents);
